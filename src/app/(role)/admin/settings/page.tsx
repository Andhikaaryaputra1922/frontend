      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-2">
            <span className="h-1 w-10 bg-[#D4AF37] rounded-full" />
            <p className="text-[10px] font-black text-[#D4AF37] uppercase tracking-[0.3em]">System Authority</p>
          </div>
          <h1 className="text-4xl font-black tracking-tight text-[#0B213F]">Admin Settings</h1>
        </div>

        <div className="rounded-[40px] border border-slate-200 bg-white p-8 md:p-12 shadow-sm border-b-8 border-b-[#0B213F]/10">
          <form onSubmit={handleSave} className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 pb-8 border-b border-slate-100">
              <div className="relative group cursor-pointer" onClick={() => document.getElementById('admin-avatar-upload')?.click()}>
                <div className="h-32 w-32 rounded-[40px] bg-[#0B213F] border-4 border-[#D4AF37]/20 overflow-hidden shadow-xl group-hover:scale-105 transition-all duration-500 relative">
                  {formData.image ? (
                    <img src={formData.image} alt="Admin" className="h-full w-full object-cover" />
                  ) : (
                    <div className="h-full w-full flex items-center justify-center text-4xl font-black text-[#D4AF37]">
                ...
                <div className="absolute -bottom-2 -right-2 h-10 w-10 bg-[#0B213F] rounded-2xl flex items-center justify-center shadow-lg border-4 border-white text-[#D4AF37]">
              ...
              <div className="flex-1 space-y-2 text-center md:text-left">
                <h3 className="text-xl font-black text-[#0B213F]">Administrator Identity</h3>
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#0B213F]/5 border border-[#0B213F]/10 text-[9px] font-black text-[#0B213F] uppercase tracking-widest">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-100 bg-slate-50 px-5 py-4 text-sm font-black text-[#0B213F] focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37] focus:bg-white outline-none transition-all"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full rounded-3xl border border-slate-100 bg-slate-50 px-5 py-5 text-sm font-bold text-[#0B213F] focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37] focus:bg-white outline-none transition-all resize-none"
              ></textarea>
            </div>
