  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] p-6 md:p-10">
      <div className="mx-auto max-w-3xl">
        <div className="mb-10">
          <h1 className="text-3xl font-black tracking-tight text-[#1A2E44]">Pengaturan Profil</h1>
          <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mt-2">Personalize your teacher presence</p>
        </div>

        <div className="rounded-[40px] border border-slate-200 bg-white p-8 md:p-12 shadow-sm border-b-8 border-b-[#E5B54F]/20">
          <form onSubmit={handleSave} className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 pb-8 border-b border-slate-100">
              <div className="relative group cursor-pointer" onClick={() => document.getElementById('avatar-upload')?.click()}>
                <div className="h-32 w-32 rounded-[40px] bg-[#1A2E44] border-4 border-[#E5B54F]/20 overflow-hidden shadow-xl group-hover:scale-105 transition-all duration-500 relative">
                  {formData.image ? (
                    ...
                    <div className="h-full w-full flex items-center justify-center text-3xl font-black text-[#E5B54F]">
                ...
                <div className="absolute -bottom-2 -right-2 h-10 w-10 bg-[#E5B54F] rounded-2xl flex items-center justify-center shadow-lg border-4 border-white text-[#1A2E44]">
              ...
              <div className="flex-1 space-y-2 text-center md:text-left">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-50 border border-slate-100 text-[10px] font-black text-[#E5B54F] uppercase tracking-widest">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full rounded-2xl border border-slate-100 bg-slate-50 px-5 py-4 text-sm font-black text-slate-800 focus:ring-2 focus:ring-[#E5B54F]/20 focus:border-[#E5B54F] focus:bg-white outline-none transition-all" 
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full rounded-3xl border border-slate-100 bg-slate-50 px-5 py-5 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-[#E5B54F]/20 focus:border-[#E5B54F] focus:bg-white outline-none transition-all resize-none"
              ></textarea>
            </div>
